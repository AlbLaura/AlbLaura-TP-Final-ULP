    ...
    <div class="row">
        <div class="col-2 pl-5 ">
            ...
            <ul>
                ...
                <li><a href="<?=base_url()?>pagina/tematica/salud">Salud</a></li>
        ...
        <div class="col-2 pr-5">
            ...
            <div class="redes">
                ...
                <a id="tw" href="https://twitter.com/" target="_blank">
                    <i class="fa-brands fa-twitter fa-2xl mt-4"></i> Twitter
                </a><br>
                <a id="ig" href="https://www.instagram.com/" target="_blank">
                    <i class="fa-brands fa-instagram fa-2xl mt-4"></i> Instagram
                </a><br>
                <a id="gh" href="https://github.com/" target="_blank">
                    <i class="fa-brands fa-github fa-2xl mt-4"></i> GitHub
                </a>
            </div> 
        </div>
    </div>
